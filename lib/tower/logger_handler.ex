defmodule Tower.LoggerHandler do
  ...
  defp handle_log_event(
    ...
    Tower.handle_exception(exception, stacktrace, log_event: log_event, captured_by: __MODULE__)
  end
  ...
  defp handle_log_event(
    ...
    Tower.handle_throw(reason, stacktrace, log_event: log_event, captured_by: __MODULE__)
  end
  ...
  defp report_exit(reason, stacktrace, log_event) do
    Tower.handle_exit(reason, stacktrace, log_event: log_event, captured_by: __MODULE__)
  end

  defp report_message(level, message, log_event) do
    Tower.handle_message(level, message, log_event: log_event, captured_by: __MODULE__)
  end
